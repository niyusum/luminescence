"""
Reference Service Implementation - ResourceService (Lumen 2025)

Purpose
-------
This is a **complete reference implementation** demonstrating all patterns, practices,
and conventions for building domain services in Lumen RPG following the LES 2025 standard.

Use this as a template when creating new services. It shows:
- Proper dependency injection
- Transaction management with DatabaseService
...
Domain
------
Manages player economic resources (lumees, lumenite, auric_coin) with:
- Add/subtract resource operations
...
class ResourceService(BaseService):
    ...
    def __init__(
        ...
        """
        Initialize ResourceService with required dependencies.
    ...
    async def get_balance(
        ...
        Example:
            >>> balance = await resource_service.get_balance(123, "lumees")
    ...
    async def subtract_resource(
        ...
        Example:
            >>> result = await resource_service.subtract_resource(
            ...     player_id=123,
            ...     resource_type="lumees",
            ...     amount=500,
            ...     reason="fusion_cost",
