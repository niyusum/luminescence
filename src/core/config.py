...
class Config:
    """
    Centralized core.configuration management for RIKI RPG Discord Bot.
    
    All core.configuration values loaded from environment variables with sensible defaults.
    ...
    def validate(cls) -> None:
        """
        Validate critical core.configuration values on startup.
        
        Raises:
            ValueError: If required core.config values are missing in production
        """
        try:
